		...
		<main>
			...
			?>
                ...
                <form action="" method="post" enctype="multipart/form-data">
                   ...
                   <input type="text" class="box" name="prov_correo" value="<?php echo $row['correoP']; ?>" placeholder="Introduce el correo del proveedor">                  
                   <input type="submit" value="Actualizar producto" name="update_prov" class="btn">
