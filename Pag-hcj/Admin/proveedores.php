		...
		<main>
            ...
            <div class="admin-product-form-container">
                ...
                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                   ...
                   <input type="text" placeholder="Ingrese correo de proveedor" name="prov_correo" class="box">
			 ...
			 <div class="table-data">
				<div class="order">
					<div class="head">
						<input type="search" id="busquedaaddpv" placeholder="Buscar..." oninput="reiniciarTablaadd()">
